    ...
    while(1){
        ...
        if (!strncmp(buf, "help\0",4)){
            ...
            if(!strcmp(current_user,"admin")){
                printf("\033[1;41m\033[1;97m   You are an administrator, so you can perform the following actions:                                  \033[0m\n\n");
                printf("-> \033[1;31mlist users                   \033[0m|-  It shows all registered users.\n");
                printf("--------------------------------------------------------------------------------------------------------\n");
                printf("-> \033[1;31mdelete user [userid#]       \033[0m|-  You can delete users.\n");
                printf("\n\033[1;41m                                                                                                        \033[0m\n\n");
            }
        }
